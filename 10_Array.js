...
// -------------------------------------------------------------------------------------------------------------------------------------------
/* |*/ console.log(fruits + fresh_fruits); // "Apple,Banana,Mango,Orange,GrapesStrawberry,Pineapple,Lichi"                                   |
/* |*/ console.log([fruits, fresh_fruits]); // "[["Apple", "Banana", "Mango", "Orange", "Grapes"], ["Strawberry", "Pineapple", "Lichi"]]"    |
/* |*/ console.log([...fruits, fresh_fruits]); // "["Apple", "Banana", "Mango", "Orange", "Grapes", ["Strawberry", "Pineapple", "Lichi"]]"   |
/* |*/ console.log([...fruits, ...fresh_fruits]); // "["Apple", "Banana", "Mango", "Orange", "Grapes", "Strawberry", "Pineapple", "Lichi"]"" |
// -------------------------------------------------------------------------------------------------------------------------------------------
